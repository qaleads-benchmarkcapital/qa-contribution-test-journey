...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("The one where the customer submits an Order Query with an empty message body", SourceLine=58)]
